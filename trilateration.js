...
function calculatePosition() {
    ...
    const D = 2 * markers[2].x - 2 * markers[1].x;
    const E = 2 * markers[2].y - 2 * markers[1].y;
    const F = Math.pow(distances[1], 2) - Math.pow(distances[2], 2) - Math.pow(markers[1].x, 2) + Math.pow(markers[2].x, 2) - Math.pow(markers[1].y, 2) + Math.pow(markers[2].y, 2);
